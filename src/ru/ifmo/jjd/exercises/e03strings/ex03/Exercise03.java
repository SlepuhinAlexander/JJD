package ru.ifmo.jjd.exercises.e03strings.ex03;
...
//                .append(countOccurrences(input[0], input[1]))   // решение через startsWith(query, offset)
    ...
    private static String[] getUserInput() {
        ...
        print("Программа ожидает от пользователя ввод двух строк и ищет количество вхождений первой строки во вторую" +
              ".\n" +
