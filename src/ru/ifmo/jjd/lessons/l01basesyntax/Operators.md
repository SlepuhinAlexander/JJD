...
### Содержание
1. [Математические операторы](#1--)
    1. [Бнарные арифметические операторы](#11---)
    2. [Унарные арифметичекие операторы](#12---)
2. [Операторы присваивания](#2--)
3. [Операторы сравнения](#3--)
4. [Логические операторы](#4--)
5. [Побитовые операторы](#5--)
    1. [О побитовом представлении числа](#51----)
    2. [Побитовые логические операторы](#52---)
    3. [Операторы сдвига](#53--)
    4. [Побитовые операторы с присваиванием](#54----)
6. [Тренарный (условный) оператор](#6---)

### 1. Математические операторы

#### 1.1. Бнарные арифметические операторы
...
#### 1.2 Унарные арифметичекие операторы
...
#### 5.1. О побитовом представлении числа
...
Получить ведущие нули можно использовав [форматирование строк](BasicInputOutput.md#11----): распознать полученное 
...
#### 5.2. Побитовые логические операторы
...
#### 5.4. Побитовые операторы с присваиванием
