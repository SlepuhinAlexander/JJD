...
1. [Математические операторы](#math)
    1. [Бинарные арифметические операторы](#binary-math)
...
1. [Тернарный (условный) оператор](#ternary)
...
#### Бинарные арифметические операторы <a name="binary-math"></a>
...
#### Побитовые операторы с присваиванием <a name="bitwise-assignment"></a>
