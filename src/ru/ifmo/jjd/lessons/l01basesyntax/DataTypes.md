...
1. [О типах данных](#data-types)
1. [Объявление и использование переменных](#using-variables)
1. [Именование переменных](#naming-variables)
1. [Примитивные типы данных](#primitives)
    1. [Тип `byte`](#byte)
    1. [Тип `short`](#short)
    1. [Тип `int`](#int)
    1. [Тип `long`](#long)
    ...
    1. [Тип `double`](#double)
    1. [Тип `char`](#char)
    1. [Тип `boolean`](#boolean)
1. [Приведение типов](#types-casting)
    1. [Автоматическое приведение типов](#autocasting)
    1. [Повышение типа при математических операциях](#upcasting)
    1. [Явное приведение типов](#explicit-casting)
...
### Примитивные типы данных <a name="primitives"></a>
