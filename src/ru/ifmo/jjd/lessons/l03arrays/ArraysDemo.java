...
public class ArraysDemo {
    ...
    private static void arrayInitializationDemo() {
        ...
        // Печать массива
        System.out.println(someArr); // [I@12edcd21
    ...
    private static void copyingArraysDemo() {
         ...
         * int[]).
         * Другими словами, в переменную copy будет скопирована ССЫЛКА на массив {1, 2, 3, 4, 5}. Сам же массив
         ...
         * Но оба массива должны быть независимы (не связаны).
         * */
         ...
         * - конечную позицию (индекс to), до которой необходимо копировать (не включая).
         *
    ...
    private static void arraysClassDemo() {
         ...
         *
         * Метод equals() сравнивает объекты, ссылки на которые ведут из arr1 и arr2. Он вернёт true если объекты
         * равны. Из этого, вообще говоря, не следует, что содержимое массивов равно. И обратное тоже не верно: два
         * разных массива с одинаковым содержимым опеделённо являются разными объектами.
         *
         * Для сравнения массивов по содержимому подходит метод Arrays.equals(). В качестве аргументов он принимает
         * два сравниваемых массива и возвращает true только если массивы имеют одинаковые типы данных, одинаковую
         * длину и на равных позициях хранят равные значения.
         * */
         ...
         * Метод принимает два аргумента: массив, который необходимо заполнить, и значение, которе нужно присвоить
         * каждому из элементов массива.
         * */
