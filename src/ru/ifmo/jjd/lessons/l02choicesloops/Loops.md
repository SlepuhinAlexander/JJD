...
при работе с массивами (см. [[Массивы]](../l03arrays/README.md)) и коллекциями.
...
[[Интерфейсы]](../l07inheritance/README.md)). На практике, `foreach` может быть использован с массивами (см. 
[[Массивы]](../l03arrays/README.md)) и большей частью колллекций<!-- (см. [[Коллекции]]())-->.
